...
def env(
    ...
    server_url_source = "CLI" if server_url else ("N8N_DEPLOY_SERVER_URL" if os.getenv("N8N_DEPLOY_SERVER_URL") else "not set")
    config_items.append(("N8N_DEPLOY_SERVER_URL", server_url_value, server_url_source))
